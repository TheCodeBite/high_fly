				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Donde sea, cuando sea..</span>
							<h1>Contactanos</h1>	
						</div>
			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">4a poniente sur, <br> Manzana 36 Lote 11 Col. Industrial</li>
							<li class="phone"><a href="">961-107-8097</a></li>
							<li class="email"><a href="">high_fly@hotmail.com</a></li>
						</ul>
					</div>
